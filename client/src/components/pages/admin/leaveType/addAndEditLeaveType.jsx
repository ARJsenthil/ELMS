...
const AddAndEditLeaveType = (props) => {
    ...
    const id = idData.name == 'leaveType'? idData.id: ( model == "edit" && router.navigate('/leaveType/listLeaveType', { replace: true }));
    useEffect(() => {
        console.log(model)
        fetchData(dispatch);
    }, [dispatch]);
    ...
    const onsubmit = () => {
        ...
        if(valid) {
            ...
            .then((res) => {
                ...
                router.navigate('/leaveType/listLeaveType', { replace: true });
